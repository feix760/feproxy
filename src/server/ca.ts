...
export function getRootCA(name: string, dir: string): RootCA {
...
function createRootCA(name: string): RootCA {
...
function setCertValidity(cert: forge.pki.Certificate) {
...
export function createCertificate(rootCA: RootCA, hostname: string): RootCA {
  const cert = forge.pki.createCertificate();
